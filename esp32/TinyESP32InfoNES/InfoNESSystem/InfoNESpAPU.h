...
#define ApuC3LinearLength   ( ( (unsigned short int)ApuC3a & 0x7f ) << 6 )
#define ApuC3LengthCounter  ( ApuAtl[ ( ( ApuC3d & 0xf8) >> 3 ) ] )
#define ApuC3Freq           ( ( ( (unsigned short int)ApuC3d & 0x07) << 8) + ApuC3c )
...
#define ApuC5CacheAddr      ( 0xc000 + (unsigned short int)(ApuC5c << 6) )
...
//  Function prototypes                                              
//-------------------------------------------------------------------
typedef void (*ApuWritefunc)(unsigned short int addr, unsigned char value);
//JJ extern ApuWritefunc pAPUSoundRegs[20];
void ApuWriteControl(unsigned short int addr, unsigned char value);
...
//JJ extern BYTE  ApuC1Atl;

//-------------------------------------------------------------------
//  Rectangle Wave #2 resources                                      
//-------------------------------------------------------------------

//JJ extern BYTE  ApuC2Atl;   

//-------------------------------------------------------------------
// Triangle Wave resources                                          
//-------------------------------------------------------------------

//JJ extern BYTE  ApuC3a;
//JJ extern BYTE  ApuC3Atl;
//JJ extern DWORD ApuC3Llc;                             //Linear Length Counter

//-------------------------------------------------------------------
//  Noise resources                                                  
//-------------------------------------------------------------------

//JJ extern BYTE  ApuC4Atl;
